...
<head>
  ...
  <title>EventLink-Usuarios</title>
...
<%if (session.getAttribute("msg")=="1"){%>
		<script>
			swal("Listo!","Ya actualizamos los datos del usuario","success","ok");
		</script>
...
<%if (session.getAttribute("msg")=="2"){%>
		<script>
			swal("Listo!","Ya eliminaste el evento permanentemente","success","ok");
		</script>
	<%session.setAttribute("msg", "null");%>	 
<%}%>
 ...
 <col width="130">
  ...
  <thead>
    ...
    <tr>
      ...
      <th bgcolor="SlateBlue ">Usuario</th>
  ...
  <tbody>
	...
	ArrayList<userData> userdatas = (ArrayList<userData>)request.getAttribute("userdatas");
	for (int i=0; i<userdatas.size(); i++){
		userData userdata = userdatas.get(i);
		%>
    <tr>
	<th  ><%= userdata.getUser() %></th>
	<th ><%= userdata.getStatusUser()%></th>
	<th ><a href = "regControler?action=SelectAdmin&id=<%=userdata.getIduser()%>">Seleccionar</a></th>
