...
<head>
  ...
  <title>EventLink-Mis Datos</title>
...
<%if (session.getAttribute("msg")=="1"){%>
		<script>
			swal("Listo!","Tus datos se actualizaron!","success","ok");
		</script>
...
<%if (session.getAttribute("msg")=="0"){%>
		<script>
		 swal("Ups!","Revisa tus contraseñas, no coinciden","error","ok");
		</script>
	<%session.setAttribute("msg", "null");%>	 
<%}%>
 			 ...
 			 <center>
				<form class="login100-form validate-form" id="register-form" action="regControler" method="post" role="form" style="display: block;">
					...
					<div class="wrap-input100 validate-input" data-validate="Por favor Ingrese una contraseÃ±a">
						<input class="input100" type="password" name="password" id="password"value="<%=pass %>">
						<span class="focus-input100"></span>
						<span class="label-input100">Contraseña</span>
					</div>
					
					<div class="wrap-input100 validate-input" data-validate="Por favor confirme la contraseÃ±a">
						<input class="input100" type="password" name="confirm-password" id="confirm-password" value="<%=pass %>">
						<span class="focus-input100"></span>
						<span class="label-input100">Repita la Contraseña</span>
					</div>
					<br></br>			<br></br>
					<div class="container-login100-form-btn">
						<button type="submit"  name="action" value="update" id="update-submit" tabindex="4" class="btn btn-outline-primary" >Actualizar Datos</button>
					</div>
