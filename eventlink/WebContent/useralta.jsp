...
<%if (session.getAttribute("msg")=="1"){%>
		<script>
			swal("Listo!","Te suscribiste correctamente","success","ok");
		</script>
...
<%if (session.getAttribute("msg")=="0"){%>
		<script>
		 swal("Ups!","Puede que ya te hayas suscripto","error","ok");
		</script>
	<%session.setAttribute("msg", "null");%>	 
<%}%>
  ...
  <nav class="navbar navbar-default navbar-trans navbar-expand-lg fixed-top">
    <div class="container">
        ...
        <span></span>
        <span></span>
      <a class="navbar-brand text-brand" href="userMenu">Event<span class="color-b">Link</span></a>
      <div class="navbar-collapse collapse justify-content-center" id="navbarDefault">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link active" href="userMenu.jsp">Home</a>
          </li>
          <li class="nav-item">
  ...
  <!--Tabla listado-->
	...
	<center>
	<form action="susControler"  method="post">
	<div class="container-login100-form-btn">
						<button type="submit" name="action" value="FindByUser" id="update-submit" tabindex="4" class="btn btn-outline-primary">Mis Suscripciones</button>
					</div>
						</form>					
 ...
 <div class="col-md-10 col-md-offset-1">
  ...
  <tbody>
	...
	<th><a href = "susControler?action=select&id=<%=eventdata.getIdevento()%>">Inscribirme</a></th>
