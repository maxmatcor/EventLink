...
<head>
  ...
  <title>EventLink-Crear Eventos</title>
...
<%if (session.getAttribute("msg")=="1"){%>
		<script>
			swal("Listo!","Ya creaste tu evento!","success","ok");
		</script>
...
<%}%>
  ...
  <!--ingreso datos para el alta-->
 			 <center>
				<form class="login100-form validate-form" id="altaEve-form" action="eventControler" method="POST" role="form" style="display: block;">
					<span class="login100-form-title p-b-43">
						Aca podes ingresar todo sobre tu nuevo evento					</span>
					...
					<p> Fecha del Evento</p>
						...
						<input class="input100" type="date" name="fechaEve" id="fechaEve"  value="<%=dateF%>"> 
						<span class="focus-input100"></span> 
					...
					<div class="container-login100-form-btn">
						<button type="submit"  name="action" value="create" id="create-submit" tabindex="4" class="btn btn-outline-primary">Dar de alta Evento</button>
					</div>
					</br>
					</div>
					</div>
