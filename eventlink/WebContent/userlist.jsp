...
<%if (session.getAttribute("msg")=="1"){%>
		<script>
			swal("Listo!","Te diste de baja correctamente","success","ok");
		</script>
...
<%if (session.getAttribute("msg")=="0"){%>
		<script>
		 swal("Ups!","No pudimos darte de baja","error","ok");
		</script>
	<%session.setAttribute("msg", "null");%>	 
<%}%>
 ...
 <div class="col-md-10 col-md-offset-1">
  ...
  <tbody>
	...
	<th><a href = "susControler?action=delete&id=<%=eventdata.getIdevento()%>">Borrar</a></th>
