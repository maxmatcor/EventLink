...
<head>
  ...
  <title>EventLink-Administrador</title>
              ...
              <div class="card-overlay-a-content">
                <div class="card-body-a">
                  <div class="price-box d-flex">
                    <span class="price-a">Usuarios</span>
                  </div>
                  <form action="regControler" method="POST">
 <button type="submit" name="action" value="FindAll" id="FindBySus-submit" tabindex="4" class="login100-form-btn">Administrar</button>  
  </form>
                </div>
              </div>
            </div>
          ...
          <div class="card-box-a card-shadow">
            ...
            <div class="card-overlay">
              <div class="card-overlay-a-content">
                <div class="card-body-a">
                  <div class="price-box d-flex">
                    <span class="price-a">Eventos</span>
                  </div>
          ...
          <div class="card-box-a card-shadow">
            ...
            <div class="card-overlay">
              <div class="card-overlay-a-content">
                <div class="card-body-a">
                  <div class="price-box d-flex">
                    <span class="price-a">Soporte</span>
                  </div>
                  <form action="helpControler" method="POST">
 <button type="submit" name="action" value="FindAll" id="FindBySus-submit" tabindex="4" class="login100-form-btn">Administrar</button>  
  </form>
                </div>
              </div>
